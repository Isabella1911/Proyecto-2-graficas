...
pub fn build_minecraft_house_scene() -> Scene {
    ...
    let grass = Material::new(
        "grass",
        Vec3::new(0.95, 0.98, 0.95),
        Some("assets/textures/grass.jpeg"),
    )
    .with_uv_scale(8.0)
    .with_specular(0.03);
    ...
    let dirt = Material::new(
        "dirt",
        Vec3::new(0.55, 0.44, 0.36),
        Some("assets/textures/dirt.jpeg"),
    )
    .with_uv_scale(4.0)
    .with_specular(0.02);
    ...
    let stone = Material::new(
        "stone",
        Vec3::new(0.72, 0.72, 0.74),
        Some("assets/textures/stone.jpeg"),
    )
    .with_uv_scale(3.0)
    .with_specular(0.06);

    let planks = Material::new(
        "planks",
        Vec3::new(0.85, 0.70, 0.52),
        Some("assets/textures/planks.jpeg"),
    )
    .with_uv_scale(2.5)
    .with_specular(0.05);
    ...
    let roof = Material::new(
        "roof",
        Vec3::new(0.95, 0.60, 0.55),
        Some("assets/textures/roof.jpeg"),
    )
    .with_uv_scale(2.0)
    .with_specular(0.04);
    ...
    let glass = Material::new(
        "glass",
        Vec3::new(0.95, 0.97, 1.0),
        Some("assets/textures/glass.jpeg"),
    )
    .with_uv_scale(1.0)
    .with_specular(0.6)
    ...
    let water = Material::new(
        "water",
        Vec3::new(0.25, 0.45, 0.95),
        Some("assets/textures/water.png"),
    )
    .with_uv_scale(6.0)
    .with_specular(0.12);
    ...
    let torch = Material::new(
        "torch",
        Vec3::new(1.00, 0.85, 0.45),
        None,
    )
    .with_emissive(Vec3::new(4.0, 2.6, 1.2));

    let tree_leaves = Material::new(
        "tree_leaves",
        Vec3::new(0.65, 0.85, 0.60),
        Some("assets/textures/tree.jpeg"),
    )
    .with_uv_scale(2.0)
    .with_specular(0.02);

    let sun = Material::new(
        "sun",
    ...
    add_box(
        &mut scene,
        Vec3::new(x0, y0, z1 - t),
        Vec3::new(door_x0, y1, z1),
        3,
    );
    add_box(
        &mut scene,
        Vec3::new(door_x1, y0, z1 - t),
        Vec3::new(x1, y1, z1),
        3,
    );
    ...
    add_box(
        &mut scene,
        Vec3::new(6.2, 2.0, z1 - t),
        Vec3::new(7.2, 3.5, z1),
        6,
    );
    add_box(
        &mut scene,
        Vec3::new(8.8, 2.0, z1 - t),
        Vec3::new(9.8, 3.5, z1),
        6,
    );
